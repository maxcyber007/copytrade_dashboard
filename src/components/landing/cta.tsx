    ...
    <section className="relative overflow-hidden px-5 py-24">
      ...
      <Reveal className="relative mx-auto max-w-3xl text-center">
        <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">
          Copy a strategy, or <span className="gold-text">publish your own</span>
        </h2>
        <p className="mx-auto mt-5 max-w-xl text-base leading-relaxed text-muted">
          Creating an account is free and takes a minute. Connect an MT4 or MT5 account when you are
          ready — or apply to publish signals and set your own terms.
        </p>
